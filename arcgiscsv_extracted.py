...
def fillFromFile(filename, GPS):
    ...
    with open(filename, 'r') as inFile:
        ...
        if not fileLine.startswith("FID,OBJECTID,StudyId,GISFile,Datafile,UserId,DeviceId,VideoRecor,"
                                   "UtcDateTim,GPSDateTim,GPSDateTime,GPSDate,GPSTime,Bearing,SpeedMPH,HDOP,"
...
# Increment the indices by 1!
                ...
                if routeID > 0:
                    ...
                    newEntry.time = datetime.strptime(lineElems[8], '%m/%d/%Y %H:%M:%S %p')
