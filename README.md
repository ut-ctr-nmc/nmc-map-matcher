...
* The algorithm is structured to map-match and maintain several "best guesses" while new trajectory points arrive; the algorithm does not expect the entire trajectory to be known when it starts. A "realtime sample" simulation is provided.
...
This project appears in the TRB Annual Meeting 2015 program as a "practice-ready" paper. It is to currently be used as a supporting library for your workflow. The quickest way to get the code running on your computer is to do the following:

1. Download and install Python 3.13 or newer
2. Install the dependencies shapely, pyproj, and networkx
3. Run the sample codes in the base directory.
